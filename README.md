...
- But we keep the first methos as default because it is faster and the purpose of the task 
  was not to achieve the most accurate mark price. (It was actually required to not attemp to match the values to 
  Deribit's mark price. But since I had plenty of time, I thought it would be a good idea to try to match them.)
- References:
